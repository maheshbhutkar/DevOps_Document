...
def s = new HashSet()
def jenkinsUrl = gitblit.getString('groovy.jenkinsServer', 'http://172.16.222.142:8080/jenkins') 
...
for(branch in s){
	def triggerUrl = jenkinsUrl + "/git/notifyCommit?url=git://172.16.222.132/$repository.name"+"&branches="+branch														 
	logger.info("Triggered from branch :"+ branch)
